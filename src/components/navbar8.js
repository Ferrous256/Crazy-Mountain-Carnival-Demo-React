    ...
    <header className="navbar8-container1">
      <header data-thq="thq-navbar" className="navbar8-navbar-interactive">
        ...
        <div data-thq="thq-navbar-nav" className="navbar8-desktop-menu">
          <nav className="navbar8-links1"></nav>
          <div className="navbar8-buttons1">
            <button className="navbar8-action11 thq-button-filled thq-button-animated">
              <a
                ...
                className="navbar8-link4"
              >
                {props.action1 ?? (
                  <Fragment>
                    <span className="navbar8-text20">Buy Tickets Now</span>
                  </Fragment>
                )}
              </a>
            </button>
              ...
              <div className="navbar8-link4-accordion">
                ...
                >
                  <span className="thq-link thq-body-small">
                    {props.link4 ?? (
                      <Fragment>
                        <span className="navbar8-text25">#tickets</span>
                      </Fragment>
                    )}
                  </span>
                            ...
                            {props.page2Description ?? (
                              <Fragment>
                                <span className="navbar8-text21">
                                  Learn more about the Montana Summer Festival.
                                </span>
                              </Fragment>
                            )}
                          </span>
                      ...
                      <div className="navbar8-menu-item3">
                        ...
                        <div className="navbar8-content3">
                          <span className="navbar8-page31 thq-body-large">
                            {props.page3 ?? (
                              <Fragment>
                                <span className="navbar8-text14">FAQ</span>
                              </Fragment>
                            )}
                          </span>
                          <span className="thq-body-small">
                            {props.page3Description ?? (
                              <Fragment>
                                <span className="navbar8-text13">
                                  Frequently Asked Questions about the Montana
                                  Summer Festival.
                                </span>
                              </Fragment>
                            )}
                      ...
                      <div className="navbar8-menu-item4">
                        ...
                        <div className="navbar8-content4">
                          <span className="navbar8-page41 thq-body-large">
                            {props.page4 ?? (
                              <Fragment>
                                <span className="navbar8-text17">Tickets</span>
                              </Fragment>
                            )}
                          </span>
                          <span className="thq-body-small">
                            {props.page4Description ?? (
                              <Fragment>
                                <span className="navbar8-text22">
                                  Get your tickets now for the Montana Summer
                                  Festival!
                                </span>
                              </Fragment>
                            )}
                  ...
                  <div className="navbar8-content7">
                    ...
                    <span className="thq-body-small">
                      {props.page3Description ?? (
                        <Fragment>
                          <span className="navbar8-text13">
                            Frequently Asked Questions about the Montana Summer
                            Festival.
                          </span>
                        </Fragment>
                      )}
...
Navbar8.defaultProps = {
  ...
  page1ImageSrc:
    'https://images.unsplash.com/photo-1518039959895-24587ab269de?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc0OTA1NDE4OXw&ixlib=rb-4.1.0&q=80&w=1080',
  link2Url: 'https://www.teleporthq.io',
  link1: undefined,
  page3Description: undefined,
  page3: undefined,
  page3ImageSrc:
    'https://images.unsplash.com/photo-1562066168-76380e847687?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc0OTA1NDE5MHw&ixlib=rb-4.1.0&q=80&w=1080',
  page4ImageSrc:
    'https://images.unsplash.com/photo-1501665531612-b43076367536?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc0OTA1NDE4OXw&ixlib=rb-4.1.0&q=80&w=1080',
  page1Description: undefined,
  link3Url: 'https://www.teleporthq.io',
  link3: undefined,
  page4: undefined,
  linkUrlPage3: 'https://www.teleporthq.io',
  page4ImageAlt: 'Image for Tickets Page',
  logoAlt: 'Montana Summer Festival Logo',
  action2: undefined,
  page1ImageAlt: 'Image for Home Page',
  page1: undefined,
  page2ImageSrc:
    'https://images.unsplash.com/photo-1560439450-57df7ac6dbef?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc0OTA1NDE4OXw&ixlib=rb-4.1.0&q=80&w=1080',
  link1Url: 'https://www.teleporthq.io',
  page3ImageAlt: 'Image for FAQ Page',
  page2ImageAlt: 'Image for About Page',
  action1: undefined,
