          ...
          <div className="blog-post-header2-title thq-flex-column">
            <div className="blog-post-header2-content1">
              ...
              <span className="thq-body-small">
                {props.category ?? (
                  <Fragment>
                    <span className="blog-post-header2-text16">Events</span>
                  </Fragment>
                )}
              </span>
            </div>
                ...
                {props.blogPostTitle ?? (
                  <Fragment>
                    <span className="blog-post-header2-text17">
                      Experience the Magic of the Montana Summer Festival
                    </span>
                  </Fragment>
                )}
              </h1>
...
BlogPostHeader2.defaultProps = {
  category: undefined,
  blogPostImageSrc:
    'https://images.unsplash.com/photo-1593558628703-535b2556320b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc0OTA1NjQyNnw&ixlib=rb-4.1.0&q=80&w=1080',
  blogPostTitle: undefined,
  avatarName: undefined,
  readTime: undefined,
  blogPostImageAlt: 'Montana Summer Festival Event',
  date: undefined,
}
